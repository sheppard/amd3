...
define('d3/base',{version: "3.3.4"}); // semver
;
define('d3/compat/date',[],function() {
...
define('d3/core/array',[],function() {
var d3_arraySlice = [].slice,
    d3_array = function(list) { return d3_arraySlice.call(list); }; // conversion for NodeLists

});

define('d3/core/document',["./array"], function() {
...
define('d3/compat/style',["../core/document"], function() {
...
define('d3/compat/index',["./date","./style"], function() {

});

define('d3/arrays/ascending',["d3/base"], function(d3) {
...
define('d3/arrays/descending',["d3/base"], function(d3) {
...
define('d3/arrays/min',["d3/base"], function(d3) {
...
define('d3/arrays/max',["d3/base"], function(d3) {
...
define('d3/arrays/extent',["d3/base"], function(d3) {
...
define('d3/arrays/sum',["d3/base"], function(d3) {
...
define('d3/math/number',[],function() {
...
define('d3/arrays/mean',["d3/base","../math/number"], function(d3) {
...
define('d3/arrays/quantile',["d3/base"], function(d3) {
...
define('d3/arrays/median',["d3/base","../math/number","./ascending","./quantile"], function(d3) {
...
define('d3/arrays/bisect',["d3/base"], function(d3) {
...
define('d3/arrays/shuffle',["d3/base"], function(d3) {
...
define('d3/arrays/permute',["d3/base"], function(d3) {
...
define('d3/arrays/pairs',["d3/base"], function(d3) {
...
define('d3/arrays/zip',["d3/base","./min"], function(d3) {
...
define('d3/arrays/transpose',["d3/base","./zip"], function(d3) {
...
define('d3/arrays/keys',["d3/base"], function(d3) {
...
define('d3/arrays/values',["d3/base"], function(d3) {
...
define('d3/arrays/entries',["d3/base"], function(d3) {
...
define('d3/arrays/merge',["d3/base"], function(d3) {
...
define('d3/arrays/range',["d3/base"], function(d3) {
...
define('d3/arrays/map',["d3/base","../core/class"], function(d3) {
...
define('d3/arrays/nest',["d3/base","./map"], function(d3) {
...
define('d3/arrays/set',["d3/base","../core/class","./map"], function(d3) {
...
define('d3/arrays/index',["./ascending","./descending","./min","./max","./extent","./sum","./mean","./median","./quantile","./bisect","./shuffle","./permute","./pairs","./zip","./transpose","./keys","./values","./entries","./merge","./range","./nest","./map","./set"], function() {

});

define('d3/behavior/behavior',["d3/base"], function(d3) {
d3.behavior = {};

return d3.behavior;
});

define('d3/core/rebind',["d3/base"], function(d3) {
...
define('d3/core/vendor',["./document"], function() {
...
define('d3/core/noop',[],function() {
function d3_noop() {}

return d3_noop;
});

define('d3/event/dispatch',["d3/base","../arrays/map"], function(d3) {
...
define('d3/event/event',["d3/base","./dispatch"], function(d3) {
...
define('d3/format/requote',["d3/base"], function(d3) {
...
define('d3/core/subclass',[],function() {
...
define('d3/selection/select',["./selection"], function() {
...
define('d3/selection/selectAll',["../core/array","./selection"], function() {
...
define('d3/core/ns',["d3/base"], function(d3) {
var d3_nsPrefix = {
...
define('d3/selection/attr',["../core/ns","./selection"], function() {
...
define('d3/format/collapse',[],function() {
...
define('d3/selection/classed',["../format/collapse","../format/requote","./selection"], function() {
...
define('d3/selection/style',["../core/document","./selection"], function() {
...
define('d3/selection/property',["./selection"], function() {
...
define('d3/selection/text',["./selection"], function() {
...
define('d3/selection/html',["./selection"], function() {
...
define('d3/selection/append',["../core/document","../core/ns","./selection"], function() {
...
define('d3/selection/insert',["./selection"], function() {
...
define('d3/selection/remove',["./selection"], function() {
...
define('d3/selection/data',["../arrays/map","./selection"], function() {
...
define('d3/selection/datum',["./selection"], function() {
...
define('d3/selection/filter',["./selection"], function() {
...
define('d3/selection/order',["./selection"], function() {
...
define('d3/selection/sort',["../arrays/ascending","./selection"], function() {
...
define('d3/selection/each',["./selection"], function() {
...
define('d3/selection/call',["../core/array","./selection"], function() {
...
define('d3/selection/empty',["./selection"], function() {
...
define('d3/selection/node',["./selection"], function() {
...
define('d3/selection/size',["./selection"], function() {
...
define('d3/selection/enter-select',["./selection","./enter"], function() {
...
define('d3/selection/enter-insert',["./selection","./enter"], function() {
...
define('d3/selection/enter',["../core/subclass","./selection","./enter-select","./enter-insert"], function() {
...
define('d3/selection/transition',["./selection"], function() {
...
define('d3/selection/interrupt',["./selection"], function() {
// import "../transition/transition";
...
define('d3/selection/selection',["d3/base","../core/array","../core/document","../core/subclass","../core/vendor","./select","./selectAll","./attr","./classed","./style","./property","./text","./html","./append","./insert","./remove","./data","./datum","./filter","./order","./sort","./on","./each","./call","./empty","./node","./size","./enter","./transition","./interrupt"], function(d3) {
...
define('d3/selection/on',["../arrays/map","../core/array","../core/document","../core/noop","../event/event","../format/requote","./selection"], function() {
...
define('d3/event/drag',["../core/document","../core/vendor","../selection/on"], function() {
...
define('d3/event/mouse',["d3/base","../core/document"], function(d3) {
...
define('d3/event/touches',["d3/base","../core/array","./event","./mouse"], function(d3) {
...
define('d3/behavior/drag',["../core/document","../core/rebind","../event/drag","../event/event","../event/mouse","../event/touches","./behavior"], function() {
...
define('d3/math/trigonometry',[],function() {
var π = Math.PI,
    ε = 1e-6,
    ε2 = ε * ε,
    d3_radians = π / 180,
...
define('d3/interpolate/zoom',["../math/trigonometry"], function() {
...
define('d3/behavior/zoom',["../core/document","../core/rebind","../event/drag","../event/event","../event/mouse","../event/touches","../selection/selection","../interpolate/zoom","./behavior"], function() {
...
define('d3/behavior/index',["./behavior","./drag","./zoom"], function() {

});

define('d3/color/color',[],function() {
function d3_Color() {}
...
define('d3/color/hsl',["d3/base","./color","./rgb"], function(d3) {
...
define('d3/color/hcl',["d3/base","../math/trigonometry","./color","./lab","./rgb"], function(d3) {
...
define('d3/color/lab',["d3/base","../math/trigonometry","./color","./hcl","./rgb"], function(d3) {
...
define('d3/color/rgb',["d3/base","../arrays/map","./color","./hsl","./lab","./xyz"], function(d3) {
...
define('d3/color/index',["./color","./rgb","./hsl","./hcl","./lab","./xyz"], function() {

});

define('d3/core/functor',["d3/base"], function(d3) {
...
define('d3/core/index',["./functor","./ns","./rebind"], function() {

});

define('d3/core/identity',[],function() {
...
define('d3/xhr/xhr',["d3/base","../core/array","../core/document","../core/identity","../core/rebind","../event/dispatch"], function(d3) {
...
define('d3/dsv/dsv',["d3/base","../arrays/set","../xhr/xhr"], function(d3) {
...
define('d3/dsv/csv',["d3/base","./dsv"], function(d3) {
...
define('d3/dsv/tsv',["d3/base","./dsv"], function(d3) {
...
define('d3/dsv/index',["./dsv","./csv","./tsv"], function() {

});

define('d3/event/timer',["d3/base","../core/document","../core/vendor"], function(d3) {
...
define('d3/event/index',["./dispatch","./event","./mouse","./touches","./timer"], function() {

});

define('d3/format/format-localized',[],function() {
...
define('d3/format/formatPrefix',["d3/base","./format"], function(d3) {
...
define('d3/format/round',["d3/base"], function(d3) {
...
define('d3/format/format',["d3/base","../arrays/map","../core/identity","./format-localized","./formatPrefix","./round"], function(d3) {
...
define('d3/format/index',["./format","./formatPrefix","./requote","./round"], function() {

});

define('d3/geo/geo',["d3/base"], function(d3) {
d3.geo = {};

return d3.geo;
});

define('d3/math/adder',[],function() {
...
define('d3/geo/stream',["./geo"], function() {
...
define('d3/geo/area',["../core/noop","../math/adder","../math/trigonometry","./geo","./stream"], function() {
...
define('d3/geo/cartesian',[],function() {
// TODO
...
define('d3/geo/spherical',["../math/trigonometry"], function() {
...
define('d3/geo/bounds',["../core/identity","../core/noop","./geo","./stream","./area","./cartesian","./spherical"], function() {
...
define('d3/geo/centroid',["../core/noop","../math/trigonometry","./geo","./stream"], function() {
...
define('d3/geo/clip-polygon',["../math/trigonometry","./spherical"], function() {
...
define('d3/geo/clip',["../arrays/merge","../core/noop","../math/trigonometry","./clip-polygon"], function() {
...
define('d3/geo/point-in-polygon',["./geo","./area","./cartesian","../math/trigonometry"], function() {
...
define('d3/geo/clip-antimeridian',["../core/true","../math/trigonometry","./clip","./point-in-polygon"], function() {
...
define('d3/geo/clip-circle',["../math/trigonometry","./cartesian","./clip","./circle","./spherical","./point-in-polygon"], function() {
...
define('d3/geo/clip-extent',["../arrays/merge","../math/trigonometry","./geo","./clip","./clip-polygon"], function() {
...
define('d3/geo/compose',[],function() {
...
define('d3/geo/conic',["../math/trigonometry","./projection"], function() {
...
define('d3/geo/conic-equal-area',["../math/trigonometry","./geo","./conic","./projection"], function() {
...
define('d3/geo/albers',["./conic-equal-area","./geo"], function() {
...
define('d3/geo/albers-usa',["./albers","./conic-equal-area","./geo"], function() {
...
define('d3/geo/path-area',["../core/noop"], function() {
...
define('d3/geo/path-bounds',["../core/noop"], function() {
...
define('d3/geo/path-buffer',[],function() {
...
define('d3/geo/path-centroid',["./centroid"], function() {
...
define('d3/geo/path-context',["../core/noop","../math/trigonometry"], function() {
...
define('d3/geo/resample',["../math/trigonometry","./cartesian","./stream"], function() {
...
define('d3/geo/transform',["./geo","../core/array"], function() {
...
define('d3/geo/path',["../core/identity","../math/trigonometry","./albers-usa","./area","./bounds","./centroid","./geo","./path-area","./path-bounds","./path-buffer","./path-centroid","./path-context","./projection","./resample","./stream","./transform"], function() {
...
define('d3/geo/projection',["../core/identity","../core/rebind","../math/trigonometry","./clip-antimeridian","./clip-circle","./clip-extent","./compose","./geo","./path","./resample","./rotation","./stream","./transform"], function() {
...
define('d3/geo/equirectangular',["./geo","./projection"], function() {
...
define('d3/geo/rotation',["../math/trigonometry","./equirectangular","./geo"], function() {
...
define('d3/geo/circle',["../math/trigonometry","./cartesian","./geo","./rotation","./spherical"], function() {
...
define('d3/geo/distance',["../math/trigonometry","./geo"], function() {
...
define('d3/geo/graticule',["../arrays/range","../math/trigonometry","./geo"], function() {
...
define('d3/core/source',[],function() {
...
define('d3/core/target',[],function() {
...
define('d3/geo/greatArc',["../core/source","../core/target","./geo","./distance"], function() {
...
define('d3/geo/interpolate',["../math/trigonometry","./geo"], function() {
...
define('d3/geo/length',["../core/noop","../math/trigonometry","./geo","./stream"], function() {
...
define('d3/geo/azimuthal',[],function() {
...
define('d3/geo/azimuthal-equal-area',["./azimuthal","./geo","./projection"], function() {
...
define('d3/geo/azimuthal-equidistant',["../core/identity","./azimuthal","./geo","./projection"], function() {
...
define('d3/geo/conic-conformal',["../math/trigonometry","./conic","./geo","./projection"], function() {
...
define('d3/geo/conic-equidistant',["../math/trigonometry","./conic","./equirectangular","./geo","./projection"], function() {
...
define('d3/geo/gnomonic',["./azimuthal","./geo","./projection"], function() {
...
define('d3/geo/mercator',["../math/trigonometry","./geo","./projection"], function() {
...
define('d3/geo/orthographic',["./azimuthal","./geo","./projection"], function() {
...
define('d3/geo/stereographic',["./azimuthal","./geo","./projection"], function() {
...
define('d3/geo/transverse-mercator',["../math/trigonometry","./geo","./mercator","./projection"], function() {
...
define('d3/geo/index',["./geo","./area","./bounds","./centroid","./circle","./distance","./graticule","./greatArc","./interpolate","./length","./path","./path-area","./path-buffer","./path-centroid","./path-context","./projection","./rotation","./stream","./transform","./albers","./albers-usa","./azimuthal","./azimuthal-equal-area","./azimuthal-equidistant","./conic-conformal","./conic-equal-area","./conic-equidistant","./equirectangular","./gnomonic","./mercator","./orthographic","./stereographic","./transverse-mercator"], function() {

});

define('d3/geom/geom',["d3/base"], function(d3) {
d3.geom = {};

return d3.geom;
});

define('d3/svg/svg',["d3/base"], function(d3) {
d3.svg = {};

return d3.svg;
});

define('d3/svg/line',["../arrays/map","../core/functor","../core/identity","../core/true","./svg"], function() {
...
define('d3/geom/hull',["../svg/line","./geom"], function() {
...
define('d3/geom/polygon',["../core/subclass","./geom"], function() {
...
define('d3/geom/delaunay',["./geom","./voronoi"], function() {
...
define('d3/geom/voronoi',["../arrays/range","../core/functor","../math/trigonometry","../svg/line","./delaunay","./geom","./polygon"], function() {
...
define('d3/geom/quadtree',["../core/functor","../svg/line","./geom"], function() {
...
define('d3/geom/index',["./geom","./hull","./polygon","./voronoi","./delaunay","./quadtree"], function() {

});

define('d3/interpolate/rgb',["../color/rgb"], function() {
...
define('d3/interpolate/object',["./interpolate"], function() {
...
define('d3/interpolate/number',[],function() {
...
define('d3/interpolate/string',["./number"], function() {
...
define('d3/interpolate/interpolate',["d3/base","../color/color","../color/rgb","./rgb","./object","./array","./number","./string"], function(d3) {
...
define('d3/interpolate/array',["./interpolate"], function() {
...
define('d3/interpolate/ease',["d3/base","../arrays/map","../core/identity","../math/trigonometry"], function(d3) {
...
define('d3/interpolate/hcl',["../color/hcl"], function() {
...
define('d3/interpolate/hsl',["../color/hsl"], function() {
...
define('d3/interpolate/lab',["../color/lab"], function() {
...
define('d3/interpolate/round',[],function() {
...
define('d3/math/transform',["d3/base","../core/document","../core/ns"], function(d3) {
...
define('d3/interpolate/transform',["../math/transform","./number"], function() {
...
define('d3/interpolate/uninterpolate',[],function() {
...
define('d3/interpolate/index',["./array","./ease","./hcl","./hsl","./interpolate","./lab","./number","./object","./rgb","./round","./string","./transform","./uninterpolate","./zoom"], function() {

});

define('d3/layout/layout',["d3/base"], function(d3) {
d3.layout = {};

return d3.layout;
});

define('d3/layout/bundle',["./layout"], function() {
...
define('d3/layout/chord',["../arrays/range","../math/trigonometry","./layout"], function() {
...
define('d3/layout/force',["../behavior/drag","../core/identity","../core/rebind","../event/event","../event/dispatch","../event/timer","../geom/quadtree","./layout"], function() {
...
define('d3/layout/hierarchy',["../arrays/merge","../core/rebind","./layout"], function() {
...
define('d3/layout/partition',["./layout","./hierarchy"], function() {
...
define('d3/layout/pie',["../arrays/range","../arrays/sum","../math/trigonometry","./layout"], function() {
...
define('d3/layout/stack',["../arrays/map","../arrays/permute","../arrays/range","./layout"], function() {
...
define('d3/layout/histogram',["../arrays/bisect","../arrays/min","../arrays/max","../core/functor","./layout"], function() {
...
define('d3/layout/tree',["./layout","./hierarchy"], function() {
...
define('d3/layout/pack',["./layout","./hierarchy","./tree"], function() {
...
define('d3/layout/cluster',["../arrays/max","./layout","./hierarchy","./tree"], function() {
...
define('d3/layout/treemap',["./layout","./hierarchy"], function() {
...
define('d3/layout/index',["./layout","./bundle","./chord","./force","./partition","./pie","./stack","./histogram","./hierarchy","./pack","./cluster","./tree","./treemap"], function() {

});

define('d3/math/random',["d3/base"], function(d3) {
d3.random = {
  normal: function(µ, σ) {
    var n = arguments.length;
    if (n < 2) σ = 1;
...
define('d3/math/index',["./random","./transform"], function() {

});

define('d3/scale/scale',["d3/base"], function(d3) {
d3.scale = {};
...
define('d3/scale/bilinear',[],function() {
...
define('d3/scale/polylinear',["../arrays/bisect"], function() {
...
define('d3/scale/linear',["../arrays/range","../core/rebind","../interpolate/interpolate","../interpolate/round","../interpolate/uninterpolate","../format/format","./bilinear","./nice","./polylinear","./scale"], function() {
...
define('d3/scale/log',["../format/format","./linear","./nice","./scale"], function() {
...
define('d3/scale/pow',["./linear","./nice","./scale"], function() {
...
define('d3/scale/sqrt',["./pow","./scale"], function() {
...
define('d3/scale/ordinal',["../arrays/map","../arrays/range","./scale"], function() {
...
define('d3/scale/category',["../color/rgb","./ordinal","./scale"], function() {
...
define('d3/scale/quantile',["../arrays/ascending","../arrays/bisect","../arrays/quantile","./scale"], function() {
...
define('d3/scale/quantize',["./scale"], function() {
...
define('d3/scale/threshold',["../arrays/bisect","./scale"], function() {
...
define('d3/scale/identity',["./linear","./scale"], function() {
...
define('d3/scale/index',["./scale","./linear","./log","./pow","./sqrt","./ordinal","./category","./quantile","./quantize","./threshold","./identity"], function() {

});

define('d3/selection/index',["./selection"], function() {

});

define('d3/svg/arc',["../core/functor","../math/trigonometry","./svg"], function() {
...
define('d3/svg/line-radial',["./arc","./line","./svg"], function() {
...
define('d3/svg/area',["../core/functor","../core/identity","../core/true","./svg","./line"], function() {
...
define('d3/svg/area-radial',["./area","./svg","./line-radial"], function() {
...
define('d3/svg/chord',["../core/functor","../core/source","../core/target","../math/trigonometry","./arc","./svg"], function() {
...
define('d3/svg/diagonal',["../core/functor","../core/source","../core/target","./svg"], function() {
...
define('d3/svg/diagonal-radial',["./arc","./diagonal","./svg"], function() {
...
define('d3/svg/symbol',["../arrays/map","../core/functor","../math/trigonometry","./svg"], function() {
...
define('d3/transition/select',["../selection/select","./transition"], function() {
...
define('d3/transition/selectAll',["../selection/select","./transition"], function() {
...
define('d3/transition/filter',["../selection/filter","./transition"], function() {
...
define('d3/transition/tween',["../selection/each","./transition"], function() {
...
define('d3/transition/attr',["../core/ns","../interpolate/interpolate","../interpolate/transform","./transition","./tween"], function() {
...
define('d3/transition/style',["../core/document","../interpolate/interpolate","./transition","./tween"], function() {
...
define('d3/transition/text',["./transition","./tween"], function() {
...
define('d3/transition/remove',["./transition"], function() {
...
define('d3/transition/ease',["../interpolate/ease","../selection/each","./transition"], function() {
...
define('d3/transition/delay',["../selection/each","./transition"], function() {
...
define('d3/transition/duration',["../selection/each","./transition"], function() {
...
define('d3/transition/each',["../selection/each","./transition"], function() {
...
define('d3/transition/subtransition',["./transition"], function() {
...
define('d3/transition/transition',["d3/base","../arrays/map","../core/subclass","../event/dispatch","../event/timer","../interpolate/ease","../selection/selection","./select","./selectAll","./filter","./attr","./style","./text","./remove","./ease","./delay","./duration","./each","./subtransition","./tween"], function(d3) {
...
define('d3/svg/axis',["../scale/linear","../scale/scale","../selection/selection","../transition/transition","./svg"], function() {
...
define('d3/svg/brush',["../core/document","../core/rebind","../event/dispatch","../event/drag","../event/event","../event/mouse","../event/touches","../scale/scale","../selection/selection","./svg"], function() {
...
define('d3/svg/index',["./svg","./arc","./line","./line-radial","./area","./area-radial","./chord","./diagonal","./diagonal-radial","./symbol","./axis","./brush"], function() {

});

define('d3/time/time',[],function() {
var d3_time = d3.time = {},
    d3_date = Date,
...
define('d3/time/format-localized',[],function() {
...
define('d3/time/interval',["./time"], function() {
...
define('d3/time/year',["./day","./interval","./time"], function() {
...
define('d3/time/day',["./interval","./time","./year"], function() {
...
define('d3/time/week',["./day","./interval","./time","./year"], function() {
...
define('d3/time/format',["../arrays/map","../format/requote","./day","./format-localized","./time","./week"], function() {
...
define('d3/time/format-utc',["./format","./time"], function() {
...
define('d3/time/format-iso',["./format","./format-utc","./time"], function() {
...
define('d3/time/second',["./interval","./time"], function() {
...
define('d3/time/minute',["./interval","./time"], function() {
...
define('d3/time/hour',["./interval","./time"], function() {
...
define('d3/time/month',["./day","./interval","./time"], function() {
...
define('d3/time/scale',["../arrays/bisect","../arrays/range","../core/rebind","../core/true","../scale/linear","../scale/nice","./day","./format","./hour","./minute","./month","./second","./time","./week","./year"], function() {
...
define('d3/time/scale-utc',["../core/true","../scale/linear","./format","./format-utc","./scale"], function() {
...
define('d3/time/index',["./time","./format-localized","./format","./format-utc","./format-iso","./interval","./second","./minute","./hour","./day","./week","./month","./year","./scale","./scale-utc"], function() {

});

define('d3/transition/index',["./transition"], function() {

});

define('d3/xhr/text',["d3/base","./xhr"], function(d3) {
...
define('d3/xhr/json',["d3/base","./xhr"], function(d3) {
...
define('d3/xhr/html',["d3/base","../core/document","./xhr"], function(d3) {
...
define('d3/xhr/xml',["d3/base","./xhr"], function(d3) {
